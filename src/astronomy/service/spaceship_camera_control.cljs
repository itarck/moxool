  ...
  (a/go-loop []
    ...
    (let [event (<! process-chan)
      ...
      (case (:event/action event)
        :spaceship-camera-control/up (let [direction (v3/multiply-scalar (m.spaceship/get-camera-direction camera) 0.03)
                                       ...
                                       (p/transact! conn [cc]))
        :spaceship-camera-control/down (let [direction (v3/multiply-scalar (m.spaceship/get-camera-direction camera) 0.03)
